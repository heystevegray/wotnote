...
const Performance = ({ activeColor = 'green' }: Props) => {
    const midiConfig = useMidiApi();

    const mapRange = ([in_min, in_max]: number[], [out_min, out_max]: number[], value: number): number => {
    ...
    const keyOff = (key: HTMLElement, previousColor = ''): void => {
