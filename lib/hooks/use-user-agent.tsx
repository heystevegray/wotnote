// Special thanks to: https://github.com/bcanfield/nextjs-pwa-webpush-template/blob/main/app/_hooks/useUserAgent.tsx
...
export default function useUserAgent() {
  ...
  useEffect(() => {
    if (window) {
      ...
      const isWindows = userAgentString.includes("Win")
      setIsWindows(isWindows)
      setOptionKey(isWindows ? "Ctrl + " : "⌘ + ")
